...
t_match = st.Page("template_matching.py", title = "Template Matching", icon = ":material/find_in_page:")
# Mini-Projects
...
pg = st.navigation(
    {
        "Learning" : [basics_page, cd_page, morph_page],
        "Object Detection & Tracking" : [bg_sub_page, t_match],
